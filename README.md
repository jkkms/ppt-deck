...
디자인 토큰을 먼저 확정하고 · 레이아웃 10종을 리듬으로 배치하고 · AI 티를 린터가 막고 · 외부 앱 없이 눈으로 검수한다
...
| --- | --- |
| 전 슬라이드가 "제목 + 불릿" 한 골격 | 레이아웃 10종을 리듬으로 배치. 같은 레이아웃 3연속은 린터가 막는다 |
...
| 폰트 크기 종류 남발 | 타입 스케일 13단. 이 표에 없는 크기는 존재하지 않는다 |
...
<tr>
<td><img src="docs/cards.png" alt="cards"><br><code>cards</code> · 번호 카드 2~6개 (썸네일 가능)</td>
<td><img src="docs/image-split.png" alt="image_split"><br><code>image_split</code> · 반출혈 이미지 + 텍스트</td>
</tr>
<tr>
